...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/c/2037296029/8969*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*Contact admin selected @babu_babu32*", parse_mode='Markdown')
    else:
